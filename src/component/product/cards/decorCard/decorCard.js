...
export const DecorCard = () => {
  ...
  <div class="carousel-indicators">
    <button type="button" data-bs-target="#carouselExampleAutoplaying" data-bs-slide-to="0" class="active" aria-current="true" aria-label="SlideDecor 1" style={{ filter: "brightness(0%)", width: "40px", height: "1px" }}></button>
    <button type="button" data-bs-target="#carouselExampleAutoplaying" data-bs-slide-to="1" aria-label="SlideDecor 2" style={{ filter: "brightness(0%)", width: "40px", height: "1px" }}></button>
  </div>
    ...
    <div class="carousel-item active" data-bs-interval="6000">
      <div className="decor-card">
        ...
        <div className="cont">
          ...
          <div className="text-wrap">
            <p className="text">
              She used her wedding magazine as a decor element on her coffee table and cherishes her wedding memories, every day.
            </p>
            <ButtonSecondary direction={true} to="/plans" text={'Renovate Yours living room'} />
          </div>
        </div>
    ...
    <div class="carousel-item" data-bs-interval="6500">
      <div className="decor-card">
        ...
        <div className="cont">
          ...
          <div className="text-wrap">
            <p className="text">
              She used her wedding magazine as a decor element on the side table and cherishes her wedding memories, every day.
            </p>
            <ButtonSecondary direction={true} to="/plans" text={'Renovate Yours Bed Room'} />
          </div>
        </div>
